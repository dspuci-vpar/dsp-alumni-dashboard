...
# Load the Excel file
df = pd.read_excel('Updated_Updated_FULL_DSP-PiSigma_Alumni_Database.xlsx', sheet_name='Sheet1')
...
df.to_excel('Updated_Role_Industry_Reasoning_FULL_DSP-PiSigma_Alumni_Database.xlsx', index=False)
